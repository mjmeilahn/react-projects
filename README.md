...
3. Basics - Exploring basic Class vs. Functional Components. Importing components, passing JS, dyanmic classNames, Props & State, Styled Components, Two-Way-Binding in JSX. Basic intro to Hooks with "useState" and how Class components can become Functional with Hooks. First look at updating Immutable State.